...
text_to_speech_url = os.getenv(
    "TTS_SERVICE_URL",
    default="http://0271714b-us-south.lb.appdomain.cloud:1080/text-to-speech/api/v1/synthesize",
)
...
app.layout = html.Div(
    children=[
                    ...
                    children=[
                        ...
                        dbc.Row(
                            [
                                dbc.Col(
                                    html.P(
                                        children="Use the sample text or enter your own text in English"
                                    ),
                                    width=8,
                                    lg=3,
                                ),
                                ...
                                dbc.Col(
                                    html.P(
                                        children="Select option for Enhanced neural voice"
                                    )
                                ),
                                dbc.Col(
                                    dcc.Dropdown(
        ...
        html.Br(),
        html.Label(
            "This App was built using Watson Speech library.",
            style={"bottom": "25px", "position": "absolute"},
        ),
        # html.Br(),
        html.Footer(
            children="Please note that this content is made available by IBM Build Lab to foster Embedded AI technology adoption. \
...
def getSpeechFromText(headers, params, data, voice_dropdown):
    ...
    request = requests.post(
        text_to_speech_url, headers=headers, params=params, data=data
    )
